...
#
#  Description: This Python script creates a IAU2000/2009/2015 WKT projection strings for WMS services
#
        ...
        for line in open(inputTable):
            ...
            if (tokens[2].replace(" ", "") != "") \
                ...
                if isInt(tokens[0]):  # is Naif number?
                    ...
                    theStr = "%r,PROJCS[\"%s_Equidistant_Cylindrical\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Equidistant_Cylindrical\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],PARAMETER[\"Standard_Parallel_1\",0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Equidistant_Cylindrical\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Equidistant_Cylindrical\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",180],PARAMETER[\"Standard_Parallel_1\",0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Sinusoidal\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Sinusoidal\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Sinusoidal\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Sinusoidal\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",180],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_North_Pole_Stereographic\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Stereographic\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],PARAMETER[\"Scale_Factor\",1],PARAMETER[\"Latitude_Of_Origin\",90],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Mollweide\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Mollweide\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Mollweide\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Mollweide\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",180],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Robinson\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Robinson\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Robinson\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Robinson\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",180],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Sinusoidal_AUTO\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Sinusoidal\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Orthographic_AUTO\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Orthographic\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Longitude_Of_Center\",0.0],PARAMETER[\"Latitude_Of_Center\",90.0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Lambert_Conformal_Conic_AUTO\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Lambert_Conformal_Conic\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],PARAMETER[\"Standard_Parallel_1\",-20],PARAMETER[\"Standard_Parallel_2\",20],PARAMETER[\"Latitude_Of_Origin\",0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Lambert_Azimuthal_Equal_Area_AUTO\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Lambert_Azimuthal_Equal_Area\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],PARAMETER[\"Latitude_Of_Origin\",90],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Albers_AUTO\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Albers\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0.0],PARAMETER[\"Standard_Parallel_1\",60.0],PARAMETER[\"Standard_Parallel_2\",20.0],PARAMETER[\"Latitude_Of_Origin\",40.0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Mollweide_AUTO\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Mollweide\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
                    ...
                    theStr = "%r,PROJCS[\"%s_Robinson_AUTO\",GEOGCS[\"%s %s\",DATUM[\"D_%s_%s\",SPHEROID[\"%s_%s_%s\",%r,%r]],PRIMEM[\"Reference_Meridian\",0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Robinson\"],PARAMETER[\"False_Easting\",0],PARAMETER[\"False_Northing\",0],PARAMETER[\"Central_Meridian\",0],UNIT[\"Meter\",1],AUTHORITY[\"IAU%s\",\"%r\"]]\n" % (
                        gisCode, theTarget, theTarget, theYear, theTarget, theYear, theTarget, theYear, group, theA, flattening, theYear, gisCode)
                    fileToOutput.write(theStr)
