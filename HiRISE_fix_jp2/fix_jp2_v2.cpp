/*
** fix_jp2_v2 (updated to not override good labels, Jan. 2023)
**
...
** or that do not have the CenterLatGeoKey or as if Jan, 2023
** already have StdParallel1GeoKey (thare@usgs.gov).
*/

// Disable fopen error on Windows
...

{
	if (argc != 2)
	{
		fprintf(stderr, "Usage: fix_jp2_v2 HiRISE_targetfile.jp2\n");
		exit(1);
	}
