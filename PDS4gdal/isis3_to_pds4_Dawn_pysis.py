#!/usr/bin/env python3
###############################################################################
#_TITLE  isis3_to_pds4_Dawn_pysis.py
#
#_ARGS
#   input.cub
#   output_config.txt
...
#/* -------------------------------------------------------------------- */
    ...
    try:
        observeID = getkey(from_=inputlbl, keyword='ObservationId', grp='Archive')
    ...
    try:
        fileName = getkey(from_=inputlbl, keyword='FileName', grp='Archive')
